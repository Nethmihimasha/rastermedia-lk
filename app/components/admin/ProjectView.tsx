...
export default function ProjectView() {
  ...
  if (status === 'loading' || loading) return <div style={styles.container}>Loading Portfolio...</div>;
          ...
          <tbody>
            {projects.map((p) => (
              <tr key={p._id} style={styles.tr}>
                ...
                <td style={styles.td}>
                  <button style={styles.btnDelete} onClick={() => handleDelete(p._id)}>Delete</button>
                </td>
              </tr>
            ))}
          </tbody>
